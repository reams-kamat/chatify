...
// 
//
$(".messenger-accountinfoView1 nav a , .show-accountSide").on("click", function() {
    $(".messenger-accountinfoView1").toggle();
  });
$(".messenger-accountinfoView1 nav a").on("click", function() {
    $(".show-accountinfoView1").show();
  });
//
// hide showing button for account section.
$(".messenger-accountinfoView nav a , .show-accountSide").on("click", function() {
    $(".messenger-accountinfoView").toggle();
  });
// x button for account section to show the main button.
$(".messenger-accountinfoView nav a").on("click", function() {
    $(".show-accountinfoView").show();
  });
