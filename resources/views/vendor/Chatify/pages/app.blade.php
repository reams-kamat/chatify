...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#" class="show-accountSide">
                    <img src="{{ asset('/storage/'.config('chatify.user_avatar.folder').'/'.Auth::user()->avatar) }}" style="width: 30px;height: 30px;display: inline;" class="avatar" >
                </a>
            ...
            <div class="messenger1">
                <div class="messenger-accountinfoView1">
                    {{-- nav actions --}}
                    <nav>
                        <a href="#"><i class="fas fa-times"></i></a>
                    </nav>
                    {!! view('Chatify::layouts.accountinfo')->render() !!}
    ...
    {{-- ---------------------- Account side ---------------------- --}}
    <div class="messenger-accountinfoView app-scroll">
        {{-- nav actions --}}
        <nav>
            <a href="#"><i class="fas fa-times"></i></a>
        </nav>
